...
def compute_max_depth(shape, max_depth=10, print_out=True):
    """Computes how deep a network should be, 
...
def get_activation_layer(activation: str) -> Union[nn.ReLU, nn.LeakyReLU, nn.ELU, nn.Softmax]:
...
class DownBlock(nn.Module):
    ...
    def __init__(
        ...
        out_channels: int,
        pooling: bool = True,
        activation: str = ActivationFunction.SOFTMAX,
...
class UNet(nn.Module):
    """
    activation: 'relu', 'leaky', 'elu', 'softmax'
